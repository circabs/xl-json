...
internals.isDir = function (toCheck) {

    try {
        toCheck = Fs.lstatSync(toCheck);
        return toCheck.isDirectory() ? true : false;
    }
    catch (e) {
        return false;
    }
...
internals.isFile = function (toCheck) {

    try {
        toCheck = Fs.lstatSync(toCheck);
        return toCheck.isFile() ? true : false;
    }
    catch (e) {
        return false;
    }
